...
class FabricationWorkflowMatcher(Matcher):
    ...
    def _build_results(self):
        ...
        CALL apoc.case([
        pathNode:Matter,
        'OPTIONAL MATCH (onto)<-[:IS_A]-(pathNode)-[node_p:HAS_PROPERTY]->(property:Property)-[:IS_A]->(property_label:EMMOQuantity) RETURN DISTINCT [pathNode.uid, property.value, onto.name + "_" + property.name] as node_info',
        pathNode:Process,
