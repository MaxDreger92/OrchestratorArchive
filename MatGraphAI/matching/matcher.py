...
class Matcher:
    """
    A generic Matcher class to run query and generate reports.
    Subclasses should implement build_query method to provide custom queries.
    """

    type = 'generic'  # type attribute for Matcher. It's 'generic' for base Matcher class.

    def __init__(self, paginator=None, force_report=False):
        """
